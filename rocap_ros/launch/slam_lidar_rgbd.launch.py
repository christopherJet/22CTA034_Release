...
def generate_launch_description():
    ...
    scan_cloud_topic_selector = [
        SetLaunchConfiguration(
            name='scan_cloud_topic', value='ray/points', condition=IfCondition(LaunchConfiguration('sim'))
        ),
        SetLaunchConfiguration(
            name='scan_cloud_topic', value='assembled_cloud', condition=UnlessCondition(LaunchConfiguration('sim'))
        )
    ]
